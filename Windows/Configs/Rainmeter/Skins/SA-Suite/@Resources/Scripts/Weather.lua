...
function netConnect()
	...
	SKIN:Bang('!UnpauseMeasureGroup SuiteWeatherMeasure')
	SKIN:Bang('!HideMeterGroup SuiteWeatherMeter')
...
function updateWeather()
	...
	SKIN:Bang('!HideMeterGroup SuiteWeatherMeter')
	SKIN:Bang('!DisableMeasureGroup SuiteWeatherMeasure')
...
function finishWeather()
	...
	SKIN:Bang('!ShowMeterGroup SuiteWeatherMeter')
	SKIN:Bang('!EnableMeasureGroup SuiteWeatherMeasure')
...
function scaleUpWeather()
	...
	SKIN:Bang('!UpdateMeterGroup SuiteWeatherMeter')
